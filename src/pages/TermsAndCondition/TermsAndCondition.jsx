...
const TermsAndCondition = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center my-auto mt-[100px] pb-[90px] gap-10">
      ...
      <div className="sm:container mx-2 sm:mx-0 sm:max-w-[80%] max-h-[90%] rounded-lg text-lg bg-gradient-to-r from-[#63A8AE] to-[#2E7Eb5] text-white flex flex-col gap-4 overflow-y-auto px-6 py-3">
        <div className="w-full container subheading ">
          {formatText("terms", "date")}
          {/* <TextBlock section={"terms"} element={"date"} /> */}
        </div>
        <div className="w-full tracking-wider text-pretty text-clip   sm:text-justify container break-words  whitespace-pre-line leading-relaxed">
          {formatText("terms", "description")}
          {/* <TextBlock section={"privacy"} element={"description"} /> */}
        </div>
        <div className="w-full subheading !font-bold container !text-xl sm:!text-2xl">
